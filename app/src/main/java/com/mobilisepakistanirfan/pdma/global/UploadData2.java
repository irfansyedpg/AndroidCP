...
public class UploadData2
{
   ...
   public static  String LastId;
    ...
    public static  String volleyPost(Context contx, JSONObject Jobj, final String type, final ArrayList<Bitmap> bitmapPic){


        String postUrl = ServerConfiguration.ServerURL+ "InsertResponse";
    ...
    public static void PushNotificaionUpload(Context mcontext,String reportype)
    {
            ...
            String link="https://madadgar.pdma.gov.pk/pdmamadadgar/Home/ComplaintsAsmnt";
            ...
            if(reportype.equals("RD"))
            {
                ...
                link="https://madadgar.pdma.gov.pk/pdmamadadgar/Home/index";
            }
