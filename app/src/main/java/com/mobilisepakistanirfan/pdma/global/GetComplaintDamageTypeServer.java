...
public class GetComplaintDamageTypeServer extends AsyncTask {
    ...
    String mUserMsg, URL;
    MyPref preferences;
    public GetComplaintDamageTypeServer(Context context, String URL) {
    ...
    protected void onPostExecute(Object o) {
        try {
            ...
            for (int i = 0; i < contacts.length(); i++) {
                ...
                lstdistrict.add(c.getString("complaint_damage_type_title"));
                lstDistriid.add(c.getString("complaint_damage_type_id"));
            ...
            LocalDataManager.InsertComplaintDamageType(lstdistrict,lstDistriid,mContext);
